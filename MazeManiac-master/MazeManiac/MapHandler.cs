...
namespace MazeManiac
{
    class MapHandler
    {
        ...
        private bool mapFight(Player p, Enemy e) {
            ...
            if (harc_log[harc_log.Count - 1] == "Játékos")
            {
                return true;
            }
            else if (harc_log[harc_log.Count - 1] == "Ellenség")
            {
        ...
        private void move(int xmod, int ymod)
        {
            ...
            try
            {
                ...
                {
                    Kétlábonjárókalasnyikov o = new Kétlábonjárókalasnyikov();
                    if (mapFight(this.p, o))
                    {
                        map[x + xmod, y + ymod] = '@';
                        map[x, y] = '.';
                ...
                {
                    this.message += "Gratulálok! Nyertél!";
